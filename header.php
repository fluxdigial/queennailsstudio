    ...
    <div class="container">
        <div class="header__wrapper">
            <div class="header__menu header__left lg:flex items-center gap-6">
                ...
                ?>
                <button type="button" class="navbar-toggler btn pr-0 toggle-menu lg:hidden" aria-label="Toggle navigation"
...
<div class="menu-mobile">
    ...
    <div class="menu-mobile-btn">
         <a href="<?= esc_url( $contact_en ); ?>"
            class="btn-call w-full px-4 py-3   text-white border-solid border-[1px] border-[#8b5e3c] bg-[#8b5e3c] text-[18px] font-medium hover:no-underline"
            aria-label="Book Now" title="Book Now">
            <?= esc_html( 'Book Now' ); ?>
        </a>
    </div>
