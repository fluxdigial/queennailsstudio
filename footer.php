...
<footer class="footer bg-[#eff0e2] pt-12 md:pt-14 lg:pt-20">
    <div class="container">
        <div class="footer__main flex flex-wrap items-center">
            ...
            <div class="w-full lg:w-35">
                ...
                <h3 class="text-heading font-bold text-[18px] mb-0 mt-6 lg:mt-8"><?php echo the_field( 'name_studio_2', 'option' ); ?></h3>
                 <ul class="footer__info list-none flex flex-col gap-3 p-0 mb-0 mt-4 text-primary">
                   <li class="text-[16px] font-medium text-primary">
                        <?php echo the_field( 'phone_2', 'option' ); ?>
                    </li>
                    <li class="text-[16px] font-medium text-primary">
                        <?php echo the_field( 'email_2', 'option' );?>
                    </li>
                    <li class="text-[16px] font-medium text-primary">
                        <?php echo the_field( 'address_2', 'option' );?>
                    </li>
                    <li class="text-[16px] font-medium text-primary">
                        <a target="_blank" href="<?php echo the_field( 'link_map_2', 'option' );?>" class="text-[#8b5e3c] items-center flex flex-wrap gap-3 hover:no-underline"><?php echo esc_html('View map') ?><?php Flux\Icon::output( 'location' ) ?></a>
                    </li>
                </ul>
            </div>
    ...
    <div class="footer__copyright pt-12 pb-8 md:pt-14 lg:pt-20">
        <div class="container flex gap-2 flex-wrap justify-center text-center text-[14px] lg:text-[16px]">
