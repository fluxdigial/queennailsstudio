...
<article <?php post_class( 'post-item img-hover group' ); ?>>
	...
	<div class="entry-content w-full mt-5">
		...
		<div class="flex flex-wrap items-center gap-2 mt-2">
			<p class="date my-0 flex flex-wrap items-center gap-1 text-heading text-base font-normal pr-2 border-solid border-r-[1px] border-[#999999] border-y-0 border-l-0">
