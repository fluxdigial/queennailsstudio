...
$name_2 = get_field( 'name_store_2' );
$tel_office_2 = get_field( 'tel_office_2' );
$add_office_2 = get_field( 'add_office_2' );
    ...
    <div class="container">
        <div class="contact__wrap grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 xl:items-start">
            <div class="contact__wrap--map wow animate__animated animate__fadeInUp">
                ...
                <?php endif; ?>
                <?php if ( ! empty( $name ) ) : ?>
                    <h2 class="text-heading font-bold text-[18px]  my-0"><?php echo $name ?></h2>
                <?php endif; ?>
                ...
                <?php if ( ! empty( $name_2 ) ) : ?>
                     <h2 class="text-heading font-bold text-[18px] mt-6 mb-0"><?php echo $name_2 ?></h2>
                 <?php endif; ?>
                <ul class="no-list p-0 m-0 flex flex-col gap-3 xl:gap-4 mt-5 xl:mt-8">
                     <?php if ( ! empty( $tel_office_2 ) ) : ?>
                    <li class="flex items-center gap-4">
                         <?= Flux\Icon::output( 'phone' ) ?>
                         <p class="py-0 m-0 text-[#000000] text-[16px] xl:text-[18px] font-light  "><?php echo $tel_office_2 ?></p>
                    </li>
                    <?php endif; ?>
                     <?php if ( ! empty( $email_2 ) ) : ?>
                    <li class="flex items-center gap-4">
                         <?= Flux\Icon::output( 'mail' ) ?>
                         <p class="py-0 m-0 text-[#000000] text-[16px] xl:text-[18px] font-light  "><?php echo $email_2 ?></p>
                    </li>
                    <?php endif; ?>
                     <?php if ( ! empty( $add_office_2 ) ) : ?>
                    <li class="flex items-center gap-4">
                         <?= Flux\Icon::output( 'add' ) ?>
                         <p class="py-0 m-0 text-[#000000] text-[16px] xl:text-[18px] font-light  "><?php echo $add_office_2 ?></p>
                    </li>
                    <?php endif; ?>
                </ul>
